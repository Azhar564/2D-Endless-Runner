...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private void GenerateTerrain(float posX, TerrainTemplateController forceterrain = null)
    {
        ...
        GameObject newTerrain = forceterrain == null ?
            GenerateFromPool(terrainTemplates[Random.Range(0, terrainTemplates.Count)].gameObject, transform) :
            GenerateFromPool(forceterrain.gameObject, transform);

        newTerrain.transform.position = new Vector2(posX, newTerrain.transform.position.y);
